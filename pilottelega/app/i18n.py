...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    "fr": {
        ...
        "main.protected_label": "Mes comptes à ne jamais retirer :",
        "main.protected_placeholder": "@moncompte1, @moncompte2, 123456789",
    ...
    "en": {
        ...
        "main.protected_label": "My accounts to never remove:",
        "main.protected_placeholder": "@myaccount1, @myaccount2, 123456789",
    ...
    "ru": {
        ...
        "main.protected_label": "Мои аккаунты, которые не удалять:",
        "main.protected_placeholder": "@мой_аккаунт1, @мой_аккаунт2, 123456789",
