...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    "fr": {
        ...
        "main.protected_label": "Personnes à ne jamais retirer (@pseudo ou ID) :",
        "main.protected_placeholder": "@pseudo ou identifiant",
        "main.protected_add": "Ajouter",
    ...
    "en": {
        ...
        "main.protected_label": "People to never remove (@username or ID):",
        "main.protected_placeholder": "@username or ID",
        "main.protected_add": "Add",
    ...
    "ru": {
        ...
        "main.protected_label": "Люди, которых не удалять (@ник или ID):",
        "main.protected_placeholder": "@ник или ID",
        "main.protected_add": "Добавить",
