...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    "fr": {
        ...
        "ou saisissez directement des comptes) :",
        "main.protected_input_placeholder": "@compte1, @compte2, 12345…",
        "main.protected_add_manual": "Ajouter à la liste",
        ...
        "main.username_tab": "Vérif. comptes",
        "common.yes": "oui",
        "username.hint": (
            "Collez des @pseudos (un par ligne) pour vérifier s'ils existent encore, "
            "leur type et s'ils sont supprimés. 1 requête par compte (limité par Telegram)."
        ),
        "username.placeholder": "@compte1\n@compte2\n@compte3",
        "username.check": "Vérifier",
        "username.empty": "Aucun compte à vérifier.",
        "username.running": "Vérification… {done}/{total}",
        "username.flood_wait": (
            "Limite Telegram atteinte : attente de {seconds}s… ({done}/{total} vérifiés)"
        ),
        "username.done": "Terminé : {found} trouvé(s), {missing} introuvable(s).",
        "username.found": "Trouvé",
        "username.not_found": "Introuvable",
        "username.col_username": "Compte",
        "username.col_status": "Statut",
        "username.col_type": "Type",
        "username.col_deleted": "Supprimé",
        "username.col_name": "Nom",
        "username.kind_user": "Utilisateur",
        "username.kind_bot": "Bot",
        "username.kind_channel": "Canal",
        "username.kind_group": "Groupe",
        "username.kind_unknown": "?",
        "removal.mode": "Mode :",
        "removal.mode_mass": "Masse (garder un seul groupe)",
        "removal.mode_user": "Par utilisateur",
        "removal.mode_deleted": "Comptes supprimés (fantômes)",
        "removal.mode_list": "Par liste (coller des comptes)",
        "removal.keep_group": "Garder le groupe :",
        "removal.deleted_group": "Nettoyer le groupe :",
        "removal.list_group": "Retirer du groupe :",
        "removal.list_hint": "Collez les comptes à retirer (@pseudo ou ID, un par ligne) :",
        "removal.list_placeholder": "@bot1\n@bot2\n123456789",
    ...
    "en": {
        ...
        "or type accounts directly):",
        "main.protected_input_placeholder": "@account1, @account2, 12345…",
        "main.protected_add_manual": "Add to list",
        ...
        "main.username_tab": "Check accounts",
        "common.yes": "yes",
        "username.hint": (
            "Paste @usernames (one per line) to check whether they still exist, "
            "their type and if they are deleted. 1 request per account (Telegram-limited)."
        ),
        "username.placeholder": "@account1\n@account2\n@account3",
        "username.check": "Check",
        "username.empty": "No account to check.",
        "username.running": "Checking… {done}/{total}",
        "username.flood_wait": (
            "Telegram limit reached: waiting {seconds}s… ({done}/{total} checked)"
        ),
        "username.done": "Done: {found} found, {missing} not found.",
        "username.found": "Found",
        "username.not_found": "Not found",
        "username.col_username": "Account",
        "username.col_status": "Status",
        "username.col_type": "Type",
        "username.col_deleted": "Deleted",
        "username.col_name": "Name",
        "username.kind_user": "User",
        "username.kind_bot": "Bot",
        "username.kind_channel": "Channel",
        "username.kind_group": "Group",
        "username.kind_unknown": "?",
        "removal.mode": "Mode:",
        "removal.mode_mass": "Bulk (keep a single group)",
        "removal.mode_user": "Per user",
        "removal.mode_deleted": "Deleted accounts (ghosts)",
        "removal.mode_list": "By list (paste accounts)",
        "removal.keep_group": "Keep group:",
        "removal.deleted_group": "Clean group:",
        "removal.list_group": "Remove from group:",
        "removal.list_hint": "Paste the accounts to remove (@username or ID, one per line):",
        "removal.list_placeholder": "@bot1\n@bot2\n123456789",
        "removal.user": "User:",
    ...
    "ru": {
        ...
        "или впишите аккаунты напрямую):",
        "main.protected_input_placeholder": "@аккаунт1, @аккаунт2, 12345…",
        "main.protected_add_manual": "Добавить в список",
        ...
        "main.username_tab": "Проверка аккаунтов",
        "common.yes": "да",
        "username.hint": (
            "Вставьте @ники (по одному в строке), чтобы проверить, существуют ли они, "
            "их тип и удалён ли аккаунт. 1 запрос на аккаунт (ограничено Telegram)."
        ),
        "username.placeholder": "@аккаунт1\n@аккаунт2\n@аккаунт3",
        "username.check": "Проверить",
        "username.empty": "Нет аккаунтов для проверки.",
        "username.running": "Проверка… {done}/{total}",
        "username.flood_wait": (
            "Достигнут лимит Telegram: ожидание {seconds}с… (проверено {done}/{total})"
        ),
        "username.done": "Готово: найдено {found}, не найдено {missing}.",
        "username.found": "Найден",
        "username.not_found": "Не найден",
        "username.col_username": "Аккаунт",
        "username.col_status": "Статус",
        "username.col_type": "Тип",
        "username.col_deleted": "Удалён",
        "username.col_name": "Имя",
        "username.kind_user": "Пользователь",
        "username.kind_bot": "Бот",
        "username.kind_channel": "Канал",
        "username.kind_group": "Группа",
        "username.kind_unknown": "?",
        "removal.mode": "Режим:",
        "removal.mode_mass": "Массово (оставить одну группу)",
        "removal.mode_user": "По пользователю",
        "removal.mode_deleted": "Удалённые аккаунты (призраки)",
        "removal.mode_list": "По списку (вставить аккаунты)",
        "removal.keep_group": "Оставить группу:",
        "removal.deleted_group": "Очистить группу:",
        "removal.list_group": "Удалить из группы:",
        "removal.list_hint": "Вставьте аккаунты для удаления (@ник или ID, по одному в строке):",
        "removal.list_placeholder": "@bot1\n@bot2\n123456789",
