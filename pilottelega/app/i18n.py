...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    "fr": {
        ...
        "main.protected_groups_label": "Mes groupes à ne jamais retirer (cochez) :",
    ...
    "en": {
        ...
        "main.protected_groups_label": "My groups to never remove from (tick):",
    ...
    "ru": {
        ...
        "main.protected_groups_label": "Мои группы, из которых не удалять (отметьте):",
